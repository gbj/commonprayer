...
use crate::{CustomEvent, EventEmitter, State, StateLink};

pub struct Cmd<T>(Box<dyn FnOnce(&web_sys::HtmlElement, &StateLink<T>)>)
where
    T: State;
    ...
    T: State,
{
    ...
    pub fn event<E>(event: CustomEvent<E>) -> Self
    where
