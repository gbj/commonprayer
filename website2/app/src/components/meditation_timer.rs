...
pub struct MeditationTimer {
    ...
    pub title: String,
    pub artist: String,
    pub pauselabel: String,
    pub stoplabel: String,
    pub resumelabel: String,
    pub minuteslabel: String,
    pub secondslabel: String,
    pub usebelllabel: String,
    pub beginlabel: String,
    total_time: Duration,
...
impl Default for MeditationTimer {
    fn default() -> Self {
        ...
        Self {
            ...
            artist: "Common Prayer".to_string(),
            pauselabel: "Pause".to_string(),
            stoplabel: "Stop".to_string(),
            resumelabel: "Resume".to_string(),
            minuteslabel: "Minutes".to_string(),
            secondslabel: "Seconds".to_string(),
            usebelllabel: "Play bell sound to begin and end meditation.".to_string(),
            beginlabel: "Begin".to_string(),
            audio: None,
