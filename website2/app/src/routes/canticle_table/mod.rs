...
impl View for CanticleTableView {
    fn title(&self) -> String {
        format!("{} – {}", t!("menu.canticle_table"), t!("common_prayer"))
    }
            ...
            <>
                ...
                <main>
                    <div class="toggle-links">
                        <a href={format!("/{}/canticle-table", self.locale)} class:current={!self.use_eow}>{{t!("version.BCP1979")}}</a>
                        <a href={format!("/{}/canticle-table/eow", self.locale)} class:current={self.use_eow}>{{t!("version.EOW")}}</a>
                    </div>
                    {if !self.use_eow {
                        bcp_table(&self.locale)
                    } else {
...
fn canticle_link(
    ...
    view! {
        <a href={format!("/{}/document/office/canticles/{}/{}", locale, number, version)}>
            {label}
        </a>
    }
}
