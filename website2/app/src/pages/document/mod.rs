...
pub fn state(locale: &str, path: &str, params: &DocumentPageParams) -> Option<DocumentPageProps> {
...
pub fn head(_locale: &str, props: &DocumentPageProps) -> Vec<Node> {
...
pub fn body(locale: &str, props: &DocumentPageProps) -> Vec<Node> {
