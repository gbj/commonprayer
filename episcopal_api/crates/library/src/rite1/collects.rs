...
lazy_static! {
    pub static ref COLLECTS_TRADITIONAL: Vec<(CollectId, CollectData)> = vec![
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Stir up thy power, O Lord, and with great might come among us; and, because we are sorely hindered by our sins, let thy bountiful grace and mercy speedily help and deliver us; through Jesus Christ our Lord, to whom, with thee and the Holy Ghost, be honor and glory, world without end. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                ...
                .label("O God, who by the leading of a star didst manifest thy only- begotten Son to the peoples of the earth: Lead us, who know thee now by faith, to thy presence, where we may behold thy glory face to face; through the same Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                .page(162)
                .tags(["Seasons of the Year"]),
        ...
        (
            ...
            CollectData {
                ...
                .tags(["Seasons of the Year"]),
                preface: "Preface of the Epiphany".into(),
                rubric_before: Some("The preceding Collect, with the Psalm and Lessons for the Epiphany, or those for the Second Sunday after Christmas Day, serves for weekdays between the Epiphany and the following Sunday. The Preface of the Epiphany is used.".into()),
                rubric_after: None
            }
        ),
        (
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty and everlasting God, who dost govern all things in heaven and earth: Mercifully hear the supplications of thy people, and in our time grant us thy peace; through Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, for ever and ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Set us free, O God, from the bondage of our sins and give us, we beseech thee, the liberty of that abundant life which thou hast manifested to us in thy Son our Savior Jesus Christ; who liveth and reigneth with thee, in the unity of the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                ...
                .tags(["Seasons of the Year"]),
                preface: "Preface of Lent".into(),
                rubric_before: Some("This Collect, with the corresponding Psalm and Lessons, serves for the weekdays which follow, except as otherwise appointed.".into()),
                rubric_after: None
            }
        ),
        (
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Gracious Father, whose blessed Son Jesus Christ came down from heaven to be the true bread which giveth life to the world: Evermore give us this bread, that he may live in us, and we in him; who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                ...
                .page(170)
                .tags(["Seasons of the Year"]),
                preface: "Preface of Holu Week".into(),
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty God, who through thine only-begotten Son Jesus Christ hast overcome death and opened unto us the gate of everlasting life: Grant that we, who celebrate with joy theday of the Lord’s resurrection, may be raised from the death of sin by thy life-giving Spirit; through the same Jesus Christ our Lord, who liveth and reigneth with thee and the same Spirit ever, one God, world without end. Amen.")
                        .response("Amen.")
                )
                .label("Easter Day")
                .page(171)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Grant, we beseech thee, Almighty God, that we who celebrate with reverence the Paschal feast may be found worthy to attain to everlasting joys; through Jesus Christ our Lord,who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty Father, who hast given thine only Son to die for our sins and to rise again for our justification: Grant us so to put away the leaven of malice and wickedness, that we may always serve thee in pureness of living and truth; through the samethy Son Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("O God, whose Son Jesus is the good shepherd of thy people: Grant that when we hear his voice we may know him who calleth us each by name, and follow where he doth lead; who, with thee and the Holy Spirit, liveth and reigneth, one God, for ever and ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("O God, who on this day didst teach the hearts of thy faithful people by sending to them the light of thy Holy Spirit: Grantus by the same Spirit to have a right judgment in all things, and evermore to rejoice in his holy comfort; through the merits of Christ Jesus our Savior, who liveth and reigneth with thee, inthe unity of the same Spirit, one God, world without end. Amen.")
                        .response("Amen.")
                )
                .label("The Day of Pentecost: Whitsunday")
                .page(175)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty and everlasting God, who hast given unto usthy servants grace, by the confession of a true faith, to acknowledge the glory of the eternal Trinity, and in the power of the Divine Majesty to worship the Unity: We beseech thee that thou wouldest keep us steadfast in this faith and worship, and bring us at last to see thee in thy one and eternal glory,O Father; who with the Son and the Holy Spirit livest and reignest, one God, for ever and ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Remember, O Lord, what thou hast wrought in us and not what we deserve; and, as thou hast called us to thy service, make us worthy of our calling; through Jesus Christ ourLord, who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.No Proper Preface is used.")
                        .response("Amen.")
                )
                .label("Proper 1")
                ...
                .tags(["Seasons of the Year"]),
                preface: "".into(),
                rubric_before: Some("On the weekdays which follow, the numbered Proper which corresponds most closely to the date of Trinity Sunday in that year is used.".into()),
                rubric_after: None
            }
        ),
        (
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Grant, O Lord, we beseech thee, that the course of this world may be peaceably governed by thy providence, and that thy Church may joyfully serve thee in confidence and serenity; through Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, for ever and ever. Amen.")
                        .response("Amen.")
                )
                .label("Proper 3")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("O God, from whom all good doth come: Grant that by thy inspiration we may think those things that are right, and by thy merciful guiding may perform the same; through Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, for ever and ever. Amen.")
                        .response("Amen.")
                )
                .label("Proper 5")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("O Almighty God, who hast built thy Church upon the foundation of the apostles and prophets, Jesus Christ himself being the chief cornerstone: Grant us so to be joined together in unity of spirit by their doctrine, that we may be made anholy temple acceptable unto thee; through the same Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, for ever and ever. Amen.")
                        .response("Amen.")
                )
                .label("Proper 8")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty God, who hast given thy only Son to be unto us both a sacrifice for sin and also an example of godly life: Give us grace that we may always most thankfully receive that his inestimable benefit, and also daily endeavorourselves to follow the blessed steps of his most holy life; through the same thy Son Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
                .label("Proper 15")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Grant, we beseech thee, merciful God, that thy Church, being gathered together in unity by thy Holy Spirit, may manifest thy power among all peoples, to the glory of thy Name; through Jesus Christ our Lord, who liveth and reigneth with thee and the same Spirit, one God, world without end. Amen.")
                        .response("Amen.")
                )
                .label("Proper 16")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("O God, forasmuch as without thee we are not able to please thee, mercifully grant that thy Holy Spirit may in all things direct and rule our hearts; through Jesus Christ our Lord, who with thee and the same Spirit liveth and reigneth, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
                .label("Proper 19")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Grant us, O Lord, not to mind earthly things, but to love things heavenly; and even now, while we are placed among things that are passing away, to cleave to those that shall abide; through Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, for ever and ever. Amen.")
                        .response("Amen.")
                )
                .label("Proper 20")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty and everlasting God, who art always more ready to hear than we to pray, and art wont to give more than either we desire or deserve: Pour down upon us the abundance ofthy mercy, forgiving us those things whereof our conscience is afraid, and giving us those good things which we are not worthy to ask, but through the merits and mediation of Jesus Christ thy Son our Lord; who liveth and reigneth with thee and the Holy Spirit, one God, for ever and ever. Amen.")
                        .response("Amen.")
                )
                .label("Proper 22")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Lord, we pray thee that thy grace may always precede and follow us, and make us continually to be given to all good works; through Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
                .label("Proper 23")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("We give thee thanks, O Lord of glory, for the example of the first martyr Stephen, who looked up to heaven and prayed for his persecutors to thy Son Jesus Christ, who standeth at thy right hand; where he liveth and reigneth with thee and the Holy Spirit, one God, in glory everlasting. Amen.")
                        .response("Amen.")
                )
                .label("Saint Stephen")
                ...
                .page(186)
                .tags(["Holy Days"]),
                preface: "Preface of the Incarnation Saint John December 27".into(),
                rubric_before: None,
                rubric_after: None
            }
        ),
        ...
        (
            ...
            CollectData {
                ...
                .label("Lord God Almighty, in whose Name the founders of this country won liberty for themselves and for us, and lit the torch of freedom for nations then unborn: Grant, we beseech thee, that we and all the people of this land may have grace to maintain these liberties in righteousness and peace; through Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, for ever and ever. Amen.")
                .page(190)
                .tags(["Holy Days"]),
                preface: "Preface of Trinity Sunday".into(),
                rubric_before: Some("The Collect “For the Nation,” page 207, may be used instead.".into()),
                rubric_after: None
            }
        ),
        (
            ...
            CollectData {
                ...
                .page(191)
                .tags(["Holy Days"]),
                preface: "Preface of All Saints Saint James July 25".into(),
                rubric_before: None,
                rubric_after: None
            }
        ),
        (
            ...
            CollectData {
                ...
                .label("O gracious God, we remember before thee this day thy servant and apostle James, first among the Twelve to suffer martyrdom for the Name of Jesus Christ; and we pray that thou wilt pour out upon the leaders of thy Church that spirit of self-denying service by which alone they may have true authority among thy people; through the same Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                .page(191)
                .tags(["Holy Days"]),
                preface: "Preface of Apostles".into(),
                rubric_before: None,
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("We thank thee, heavenly Father, for the witness of thine apostle and evangelist Matthew to the Gospel of thy Son our Savior; and we pray that, after his example, we may withready wills and hearts obey the calling of our Lord to follow him; through Jesus Christ our Lord, who liveth and reignethwith thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
                .label("Saint Matthew")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty and gracious Father, we give thee thanks for the fruits of the earth in their season and for the labors of those who harvest them. Make us, we beseech thee, faithful stewards of thy great bounty, for the provision of our necessities andthe relief of all who are in need, to the glory of thy Name; through Jesus Christ our Lord, who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
                .label("Thanksgiving Day")
                .page(194)
                .tags(["Holy Days"]),
                preface: "Preface of Trinity Sunday 194 Collects: Traditional".into(),
                rubric_before: None,
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty and everlasting God, we thank thee for thyservant N., whom thou didst call to preach the Gospel to the people of__________ (or to the___________ people). Raise up, we beseech thee, in this and every land evangelists and heralds of thy kingdom, that thy Church may proclaim the unsearchable riches of our Savior Jesus Christ; who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.or this")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("O heavenly Father, Shepherd of thy people, we give thee thanks for thy servant N., who was faithful in the care and nurture of thy flock; and we pray that, following his example and the teaching of his holy life, we may by thy grace growinto the stature of the fullness of our Lord and Savior Jesus Christ; who liveth and reigneth with thee and the Holy Spirit, one God, for ever and ever. Amen.or this")
                        .response("Amen.")
                )
                .label("Of a Pastor")
                .page(197)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("O God, by whose grace thy servant N., enkindled with the fire of thy love, became a burning and a shining light in thy Church: Grant that we also may be aflame with the spiritof love and discipline, and may ever walk before thee as children of light; through Jesus Christ our Lord, who with thee, in the unity of the Holy Spirit, liveth and reigneth, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
                .label("Of a Monastic")
                .page(198)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("1. Of the Holy TrinityAlmighty God, who hast revealed to thy Church thine eternal Being of glorious majesty and perfect love as one God in Trinity of Persons: Give us grace to continue steadfast in the confession of this faith, and constant in our worship of thee, Father, Son, and Holy Spirit; who livest and reignest, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
                .label("For optional use, when desired, subject to the rules set forth in the Calendar of the Church Year.")
                .page(199)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty and most merciful God, grant, we beseech thee,that by the indwelling of thy Holy Spirit we may be enlightened and strengthened for thy service; through Jesus Christ our Lord, who liveth and reigneth with thee, in the unity of the same Spirit ever, one God, world without end. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Especially suitable for FridaysAlmighty God, whose beloved Son willingly endured the agony and shame of the cross for our redemption: Give us courage, we beseech thee, to take up our cross and follow him; who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                ...
                preface: "".into(),
                rubric_before: None,
                rubric_after: Some("Preface of the Commemoration of the Dead The postcommunion prayer on page 482 may be used.".into())
            }
        ),
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty and everlasting God, whose will it is to restore all things in thy well-beloved Son, the King of kings and Lord oflords: Mercifully grant that the peoples of the earth, divided and enslaved by sin, may be freed and brought together under his most gracious rule; who liveth and reigneth with thee and the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("For use on the traditional days or at other timesI. For those to be ordainedAlmighty God, the giver of all good gifts, who of thy divine providence hast appointed various orders in thy Church: Give thy grace, we humbly beseech thee, to all who are [now] called to any office and ministry for thy people; and so fill them with the truth of thy doctrine and clothe them with holiness of life, that they may faithfully serve before thee, to the glory of thy great Name and for the benefit of thy holy Church; through Jesus Christ our Lord, who liveth and reigneth with thee, in the unity of the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("O God, who hast made of one blood all the peoples of the earth, and didst send thy blessed Son to preach peace to those who are far off and to those who are near: Grant that people everywhere may seek after thee and find thee, bring the nations into thy fold, pour out thy Spirit upon all flesh, and hasten the coming of thy kingdom; through the same thySon Jesus Christ our Lord, who liveth and reigneth with thee and the same Spirit, one God, now and for ever.Amen.or this")
                        .response("Amen.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Almighty God, whose Son Jesus Christ in his earthly life shared our toil and hallowed our labor: Be present withthy people where they work; make those who carry onthe industries and commerce of this land responsive to thy will; and give to us all a pride in what we do, and a just return for our labor; through Jesus Christ our Lord, who liveth and reigneth with thee, in the unity of the Holy Spirit, one God, now and for ever. Amen.")
                        .response("Amen.")
                )
