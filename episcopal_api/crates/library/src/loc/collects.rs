...
lazy_static! {
    pub static ref COLECTAS: Vec<(CollectId, CollectData)> = vec![
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios todopoderoso, danos gracia para despojarnos de las obras de las tinieblas y revestirnos con las armas de la luz, ahora en esta vida mortal, en la cual Jesucristo tu Hijo, con gran humildad, vino a visitarnos; a fin de queen el día postrero, cuando vuelva con majestad gloriosa a juzgar a vivos y muertos, resucitemos a la vida inmortal; mediante él, quien vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios todopoderoso, te suplicamos que purifiques nuestra conciencia con tu visitación diaria, para que, cuando venga tu Hijo Jesucristo, encuentre en nosotros la mansión que le ha sido preparada; quien vive y reina contigo, en la unidad del Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Dios, que has hecho resplandecer esta noche santa con la claridad de la Luz verdadera: Concede a los que hemos conocido el misterio de esa Luz en la tierra, que también nos gocemos de él plenamente, en el cielo; donde vive y reina contigo y el Espíritu santo, un solo Dios, en gloria eterna. Amén.o bien:")
                        .response("Amén.")
                )
                .label("Natividad de Nuestro Señor: Día de Navidad")
                    .subtitle("Diciembre 25")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Padre eterno, tú diste a tu Hijo encarnado el santonombre de Jesús para ser el signo de nuestra salvación: Te suplicamos que siembres en cada corazón el amor de quien es el Salvador del mundo, nuestro Señor Jesucristo; que vive y reina contigo y el Espíritu Santo, un solo Dios, en gloria eterna. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Líbranos, oh Dios, de la esclavitud de nuestros pecados, y danos la libertad de esa vida abundante que nos has manifestado en tu Hijo, nuestro Salvador Jesucristo; que vive y reina contigo, en la unidad del Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Padre bondadoso, cuyo bendito Hijo Jesucristo descendió del cielo para ser el pan verdadero que da vida al mundo: Danos siempre este pan, para que él viva en nosotros y nosotros en él; quien vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios todopoderoso, cuyo muy amado Hijo no ascendió al gozo de tu presencia sin antes padecer, ni entró en gloria sin antes ser crucificado: Concédenos, por tu misericordia, que nosotros, caminando por la vía de la cruz, encontremos que ésta es la vía de la vida y de la paz; por Jesucristo tu Hijo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
                .label("Lunes Santo")
                .page(135)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Mira con bondad, te suplicamos, Dios omnipotente, a esta tu familia, por la cual nuestro Señor Jesucristo aceptó ser traicionado y entregado a hombres crueles, y sufrir muerte en la cruz; quien vive ahora y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
                .label("Viernes Santo")
                .page(136)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Dios, Creador de cielo y tierra: Concede que, así como el cuerpo crucificado de tu amado Hijo fue puesto en el sepulcro y descansó en este Sábado santo, de la misma manera aguardemos con él la venida del tercer día, y resucitemos con él a la vida nueva; quien viveahora y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
                .label("Sábado Santo")
                .page(136)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Dios, cuyo bendito Hijo se dio a conocer a sus discípulos en la fracción del pan: Abre los ojos de nuestra fe, para que podamos contemplarle en toda su obra redentora; quien vive y reina contigo, en la unidad del Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Dios, cuyo Hijo Jesús es el buen pastor de tu pueblo: Concede que, al escuchar su voz, reconozcamos a aquél que llama a cada uno de nosotros por su nombre, y le sigamos a donde nos guíe; quien contigo y el Espíritu Santo vive y reina, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Dios, Rey de la gloria, que con gran triunfo exaltastea tu único Hijo Jesucristo a tu reino celestial: No nos dejes desconsolados, mas envíanos tu Espíritu Santo para fortalecernos y exaltarnos al mismo lugar, adondenuestro Salvador Cristo nos ha precedido; quien vive y reina contigo y el Espíritu Santo, un solo Dios, en gloria eterna. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Recuerda, oh Señor, lo que has forjado en nosotros y no lo que merecemos; y, puesto que nos has llamado para servirte, haznos dignos de nuestro llamado; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
                .label("Propio 1")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios omnipotente y de misericordia, guárdanos en tu bondad de todo aquello que pueda causarnos daño; para que, dispuestos tanto en mente como en cuerpo, y con alegría de corazón, logremos lo que sea propio a tus designios; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
                .label("Propio 2")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Concede, oh Señor, que el curso de este mundo seagobernado pacíficamente por tu providencia, y que tuIglesia pueda servirte con gozo, confianza y serenidad;por Jesucristo nuestro Señor, que vive y reinacontigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
                .label("Propio 3")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Mantén, oh Señor, a tu familia, la Iglesia, en tu constante fe y amor; para que, mediante tu gracia, proclamemos tu verdad con valentía, y administremos tu justicia con compasión; por amor de nuestro Salvador Jesucristo, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
                .label("Propio 6")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Señor, haz que tengamos perpetuo amor y reverenciaa tu santo Nombre, pues nunca privas de tu auxilio yguía a los que has establecido sobre la base firme de tu bondad; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
                .label("Propio 7")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Que tu constante misericordia purifique y defienda a tu Iglesia, oh Señor; y, puesto que no puede continuar en seguridad sin tu auxilio, protégela y dirígela siempre portu bondad; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
                .label("Propio 13")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Concede, oh Dios de misericordia, que tu Iglesia,congregada en unidad por tu Espíritu Santo, manifiestetu poder entre todos los pueblos, para gloria de tu Nombre; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
                .label("Propio 16")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Dios, puesto que sin ti no podemos complacerte: Concede, por tu misericordia, que tu Espíritu Santo dirija y gobierne nuestros corazones; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
                .label("Propio 19")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Omnipotente y sempiterno Dios, tú estás siempre más presto a escuchar que nosotros a orar, y a ofrecer másde lo que deseamos o merecemos: Derrama sobre nosotros la abundancia de tu misericordia, perdonándonos todo aquello que perturba nuestra conciencia, y otorgándonos aquello que no somos dignos de pedirte, sino por los méritos y mediación de Jesucristonuestro Salvador; que vive y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
                .label("Propio 22")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Te rogamos, oh Señor, que tu gracia siempre nos preceda y acompañe, para que continuamente nos dediquemos a buenas obras; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
                .label("Propio 23")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Te damos gracias, oh Señor de la gloria, por el ejemplo del protomártir Esteban, quien, mirando hacia el cielo, intercedió por sus perseguidores ante tu Hijo Jesucristo, que está a tu diestra; donde vive y reina contigo y el Espíritu Santo, un solo Dios, en gloria eterna. Amén.")
                        .response("Amén.")
                )
                .label("San Esteban")
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios todopoderoso y eterno, humildemente te rogamos que, así como tu Hijo unigénito fue presentado en el templo en este día, así seamos presentados ante ti con corazones puros y limpios; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios omnipotente, por cuya gracia y poder tu santo mártir N. triunfó sobre el sufrimiento, y fue fiel hasta la muerte: Concede ahora a cuantos le recordamos con acción de gracias que seamos fieles en nuestro testimonio de ti en este mundo, de tal modo que recibamos con él la corona de vida; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.o la siguiente:")
                        .response("Amén.")
                )
                .label("De un Mártir")
                .page(164)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Dios, que nos has acercado a la compañía innumerable de los ángeles y de los espíritus de los justos hechos perfectos: Concede que moremos en su comunión durante nuestra peregrinación terrenal, y en nuestrapatria celestial lleguemos a ser partícipes de su gozo; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.o bien:")
                        .response("Amén.")
                )
                .label("De un Santo")
                .page(168)
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios omnipotente y de toda misericordia, concede que, morando en nosotros tu Espíritu Santo, seamos iluminados y fortalecidos para servirte; por Jesucristo nuestro Señor, que vive y reina contigo, en la unidad del Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Especialmente adecuada para los juevesDios y Padre nuestro, cuyo Hijo nuestro Señor Jesucristo nos dejó en un Sacramento maravilloso el memorial de su pasión: Concede que de tal modo veneremos los sagrados misterios de su Cuerpo y Sangre, que podamos discernir constantemente en nosotros el fruto de su redención; quien vive y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Especialmente adecuada para los viernesDios omnipotente, cuyo amado Hijo sufrió voluntariamente la agonía e ignominia de la cruz por nuestra redención: Danos valor para tomar nuestra cruz y seguirle; quien vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios omnipotente, que por nuestro bautismo en la muerte y resurrección de tu Hijo Jesucristo nos conviertes de la vieja vida de pecado: Concede que, renaciendo a una vida nueva en él, vivamos en justicia y santidad todos nuestros días; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Concede, oh Dios todopoderoso, a quienes hemos sido redimidos de la vieja vida de pecado por nuestro bautismo en la muerte y resurrección de tu Hijo Jesucristo, que seamos renovados en tu Espíritu Santo, yvivamos en justicia y verdadera santidad; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Oh Dios, que inspiraste a tus santos apóstoles a ordenar ministros en todo lugar: Concede que tu Iglesia, bajo la dirección del Espíritu Santo, escoja personas idóneaspara el ministerio de la Palabra y de los Sacramentos, y susténtalas en su obra para la extensión de tu reino; por él que es el Pastor y Obispo de nuestras almas, Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, por los siglos de los siglos. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Padre celestial, dador de vida y de salud: Consuela y alivia a tus siervos enfermos (y especialmente a N., o NN.) y concede tu poder de sanidad a quienes les ministran en sus necesidades, para que aquéllos por quienes se ofrecen nuestras oraciones sean fortalecidos en su debilidad, y tengan confianza en tu amoroso cuidado; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
        ...
        (
            ...
            CollectData {
                document: Document::from(
                    Text::from("Dios omnipotente, que nos has creado a tu propia imagen: Concédenos gracia para luchar valerosamente contra el mal, y nunca transigir con la opresión; y, para que hagamos reverente uso de nuestra libertad, ayúdanosa emplearla en el sostenimiento de la justicia en nuestras comunidades y entre las naciones, para gloria de tu santo Nombre; por Jesucristo nuestro Señor, que vive y reina contigo y el Espíritu Santo, un solo Dios, ahora y por siempre. Amén.")
                        .response("Amén.")
                )
