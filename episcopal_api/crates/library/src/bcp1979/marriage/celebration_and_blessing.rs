...
lazy_static! {
    pub static ref CELEBRATION_AND_BLESSING_OF_A_MARRIAGE: Document = Document::new()
        ...
        .content(Content::Liturgy(Liturgy::from(Series::from(vec![
            ...
            Document::from("I require and charge you both, here in the presence of God, that if either of you know any reason why you may not be united in marriage lawfully, and in accordance with God’s Word, you do now confess it."),
            ...
            Document::from(Content::DocumentLink(Version::BCP1979, "Additional Directions".into(), "marriage".into(), "additional-directions".into())),
            ...
            Document::from(Rubric::from("The people remain standing. The husband and wife kneel, and the Priest says one of the following prayers")),
            Document::from(Choice::from(vec![
