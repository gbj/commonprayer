...
lazy_static! {
    ...
    (
            ...
            document:                     Document::from(
                    ...
                    .label("O God, by the leading of a star you manifested your only Son to the peoples of the earth: Lead us, who know you now by faith, to your presence, where we may see your glory face to face; through Jesus Christ our Lord, who lives and reigns with you and the Holy Spirit, one God, now and for ever.")
                    .page(214)
                    .tags(["Seasons of the Year"])
                ,
    ...
    (
            ...
            document:                     Document::from(
                    ...
                    .label("Remember, O Lord, what you have wrought in us and not what we deserve; and, as you have called us to your service, make us worthy of our calling; through Jesus Christ our Lord, who lives and reigns with you and the Holy Spirit, one God, now and for ever.")
                    .page(228)
                    .tags(["Seasons of the Year"])
                ,
            preface: "".into(),
    ...
    (
            ...
            document:                     Document::from(
                    ...
                    .label("Conversion of Saint Paul January 25")
                    .page(239)
                    .tags(["Holy Days"])
                ,
            preface: "Preface of Apostles".into(),
