...
lazy_static! {
    pub static ref AN_ORDER_FOR_MARRIAGE_2: Document = Document::new()
        ...
        .content(Content::Liturgy(Liturgy::from(Series::from(vec![
            ...
            Document::from(Content::DocumentLink(Version::BCP1979, "BCP Marriage Service".into(), "marriage".into(), "celebration-and-blessing-of-a-marriage".into())),
            Document::from(Content::DocumentLink(Version::Expansive, "The Witnessing and Blessing of a Marriage".into(), "marriage".into(), "witnessing-and-blessing-marriage".into())),
            Document::from(Content::DocumentLink(Version::Expansive, "The Celebration and Blessing of a Marriage 2".into(), "marriage".into(), "celebration-and-blessing-of-a-marriage-2".into())),
